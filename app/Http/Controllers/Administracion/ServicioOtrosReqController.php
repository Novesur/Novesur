...
class ServicioOtrosReqController extends Controller
{
    public function listproyOtrosReq(Request $request)
    {
        ...
        $otrosReqServicio = OtrosRequerimientosServicio::where('pk_Servicios', $servicio->id)->get();
        ...
        if ($countServOtrosReq->count() == 0) {
            foreach ($otrosReqServicio as $otrosReq) {
                ...
                $servicioInforme_OtrosRequerimientos->descripcion = $otrosReq->descripcion;
                $servicioInforme_OtrosRequerimientos->cantidad = $otrosReq->cantidad;
                ...
                $servicioInforme_OtrosRequerimientos->unidmedida_id = $otrosReq->unidmedida_idInfoValor;
