...
class CreateProyectoReqmaterialesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('proyecto_reqmateriales', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('proyecto_reqmateriales');
    }
}
