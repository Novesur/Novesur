...
class CreateCotizacionLibreTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cotizacion_libre', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('cotizacion_libre');
    }
}
