...
<table width="100%" border="0">
  ...
  <tr>
    <td align="center"><strong>INFORME DE PRODUCCION Nr° {{$InformeServicio->codigo}}</strong></td>
  </tr>
</table>
<table width="100%" border="0">
  <tr>
    <td width="25%" style="font-size: 14px"><strong>MES/AÑO/FECHA :</strong></td>
    <td colspan="3" style="font-size: 12px">  {{date('d-m-Y', strtotime($InformeServicio->fecha))}}</td>
  </tr>

    <td style="font-size: 14px"><strong>COD.SERVICIO :</strong></td>
    <td colspan="3" style="font-size: 12px">{{$InformeServicio->ord_servicio}}</td>
  </tr>

  <tr>
    <td style="font-size: 14px"><strong>CLIENTE :</strong></td>
    <td colspan="3" style="font-size: 12px">{{$InformeServicio->cliente}}</td>
  </tr>

  <tr>
    <td style="font-size: 14px"><strong>DETALLE DEL SERVICIO :</strong></td>
    <td colspan="3" style="font-size: 12px">{{$InformeServicio->detservicio}}</td>
  </tr>

  <tr>
    <td style="font-size: 14px"><strong>CANTIDAD:</strong></td>
    <td colspan="3" style="font-size: 12px">{{$InformeServicio->cantidad}}</td>
  </tr>
