...
<body>
    <table width="100%" border="0">
        <tr>
            <td align="center" style="font-size:10px">
                <p><strong>INVERSIONES NOVESUR SAC<br />
                        RUC 20492421406
                    </strong><br />
                </p>
            </td>
        ...
        <tr>
            <td width="9%">&nbsp;</td>
            <td colspan="2" align="center"><strong>INFORME DE PRODUCCION Nr° {{ $InfoProduccion->codigo }}</strong>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2">
                {{ $InfoProduccion->producto->familia->nombre . ' ' . $InfoProduccion->producto->subfamilia->nombre . ', MODELO ' . $InfoProduccion->producto->modelotipo->nombre . ', MATERIAL ' . $InfoProduccion->producto->material->nombre . ', MARCA ' . $InfoProduccion->producto->marca->nombre . ', - ' . $InfoProduccion->producto->homologacion->nombre }}
            </td>
        </tr>
    ...
    <table width="100%" border="1">
        ...
        @if ($InfoProduccionMaterial)
            @foreach ($InfoProduccionMaterial as $data)
                <tr>
    ...
    <table width="100%" border="1">
        <tr>
            <td width="33%" align="center" bgcolor="#33CCFF"><strong>REQUERIMIENTO MANO DE OBRA (DIAS, HORAS,
                    HOMBRE)</strong></td>
        ...
        @if ($InfoProduccionManoObra)
            @foreach ($InfoProduccionManoObra as $dataManObra)
                <tr>
        ...
        <td align="center">
            ...
            @if ($InfoProduccionManoObra)
                @foreach ($InfoProduccionManoObra as $data)
                    @php
    ...
    <table width="100%" border="1">
        ...
        @if ($InfoProduccionManoObra)
            @foreach ($InfoProduccionOtrosRequerimientos as $dataOtrosReq)
                <tr>
        ...
        <tr>
            ...
            <td align="center">
                ...
                @if ($InfoProduccionOtrosRequerimientos)
                    @foreach ($InfoProduccionOtrosRequerimientos as $data)
                        @php
