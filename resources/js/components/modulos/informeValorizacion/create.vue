  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-dark">Informe Valorización - Proyectos</h1>
          </div>
        </div>
      </div>
    </div>
                ...
                <form role="form">
                    ...
                    <div class="col-md-9">
                      <div class="form-group row">
                        <label class="col-md-2 col-form-label"
                          >Cod. Req.Materiales - Proyecto</label
                        >
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-8">
                            <el-select
                              v-model="fillCrearInformeValorizacion.nIdCcostos"
                              style="width: 90%"
                              filterable
                              placeholder="Select"
                              disabled
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <el-date-picker
                              v-model="fillCrearInformeValorizacion.FInicio"
                              type="date"
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input
                              type="text"
                              class="form-control"
                              v-model="fillCrearInformeValorizacion.nIdOS"
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-9">
                        <div class="form-group row">
                          <label class="col-md-2 col-form-label">Importe O/S (S/.)</label>
                          <div class="col-md-2">
                            <input
                              type="text"
                              class="form-control"
                              v-model="fillCrearInformeValorizacion.cImporte"
                            />
                          </div>
                        </div>
                      </div>
              ...
              <div class="card card-primary">
                ...
                <div class="card-body table-responsive">
                  <table class="table table-hover table-head-fixed text-nowrap projects">
                    ...
                    <tbody>
                      <tr
                        v-for="(item, index) in listProyInfoValorMateriales"
                        :key="index"
                      >
                        <td v-text="item.producto.codigo"></td>
                        <td v-text="item.cantInfoValor"></td>
                        ...
                        <td
                          ...
                          "
                        ></td>
                        <td v-text="item.unidmedidaInfoValor_id.nombre"></td>
                        <td>
                          <button
                            v-if="
                            ...
                            @click.prevent="DeletListInfoValMateriales(item.id)"
                          >
                          ...
                          <button
                            ...
                            @click.prevent="abrirModalReqMateriales(item.id)"
                          >
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <el-radio
                      v-model="fillCrearInformeValorizacion.radTipoTiempo"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <input
                      ...
                      v-model="fillCrearInformeValorizacion.cDiasMObra"
                      v-int
                    />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <input
                      ...
                      v-model="fillCrearInformeValorizacion.cHorasMObra"
                      v-int
                    />
                  </div>
                </div>
                ...
                <tr v-for="(item, index) in listInfoValorManoObra" :key="index">
                  ...
                  <td>
                    <button
                      class="btn btn-danger btn-sm"
                      @click.prevent="
                        DeletListReqMaNObra(item.id, item.pk_informe_valorizacion)
                      "
                    >
                      <i class="fas fa-trash-alt"></i>
                      Eliminar
              ...
              <div class="card-body">
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                      <el-select
                        v-model="fillCrearInformeValorizacion.nIdUnidMedOtrosReq"
                        placeholder="Select"
                        style="width: 70%"
                      >
                        <el-option
                ...
                <tr v-for="(item, index) in listProyOtrosReq" :key="index">
                  ...
                  <td>
                    <button
                      class="btn btn-danger btn-sm"
                      @click.prevent="
                        DeletListOtrosReq(item.id, item.pk_proyecto_reqmateriales)
                      "
                    >
                      <i class="fas fa-trash-alt"></i>
                      Eliminar
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <el-select
                  v-model="fillCrearInformeValorizacion.cDescripcionModal"
                  style="width: 90%"
                  filterable
                  placeholder="Select"
                  :disabled="true"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-3">
                <el-select
                  v-model="fillCrearInformeValorizacion.nIdUnidMedOtrosReqModal"
                  placeholder="Select"
                  style="width: 70%"
                >
                  <el-option
...
export default {
  ...
  methods: {
    ...
    DeletListInfoValMateriales(item) {
      var url = "/administracion/informeValorizacion/reorderReqMateriales";
      axios
        .post(url, {
          item: item,
        })
    ...
    abrirModalReqMateriales(item) {
      ...
      var url = "/administracion/ProyectoMateriales/getDataModalReqMateriales";
      axios
        .post(url, {
          item,
        })
    ...
    editReqMateriales() {
      var url = "/administracion/ProyectoMateriales/EditModalReqMateriales";
      axios
        .post(url, {
