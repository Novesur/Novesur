                    ...
                    <div class="row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <el-input
                              ...
                              v-model="fillEditOrdenCompra.cDocEnvio"
                            >
                            </el-input>
                          </div>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <el-select
                              v-model="fillEditOrdenCompra.nIdTipoMoneda"
                              placeholder="Select"
                              style="width: 70%"
                            >
                              <el-option
...
export default {
  ...
  methods: {
    ...
    getCargaDetalleOrdenCompraEdit(item) {
      var url = "/administracion/DetalleordenCompra/CargaDetalleOrdenCompraEdit";
      axios
        .post(url, {
          item: item,
        })
    ...
    getCargaDatosOrdenCompra() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.fillEditOrdenCompra.cReferencia = response.data.ordencompras.Referencia;
          this.fillEditOrdenCompra.cFechaEmision = response.data.ordencompras.Femision;
          this.fillEditOrdenCompra.cFechaEntrega = response.data.ordencompras.Fentrega;
          ...
          this.fillEditOrdenCompra.cDocEnvio =
            response.data.ordencompras.documento_enviar;
    ...
    DeleteItemDetalleOrdenCompra(item) {
      var url = "/administracion/DetalleordenCompra/DeleteItemDetalleOrdenCompra";
      axios
        .post(url, {
          item: item,
        })
    ...
    getListarUnidadMedida() {
      ...
      axios.get(url).then((response) => {
        ...
        this.fillEditOrdenCompra.nIdUnidMed = this.listUnidMed[10].id;
      });
    },
    limpiarCriteriosBsq() {
      this.fillEditOrdenCompra.cProveedor = "";
