    ...
    <div>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Guia de Remisión</h1>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        getListTipoTraslado() {
            var url = "/administracion/GuiaRemision/tipotraslado";
        ...
        getListModTransporte() {
            var url = "/administracion/GuiaRemision/ListModTransporte";
            axios.get(url, {}).then((response) => {
        ...
        setProcesar() {
            var url = "/operacion/GuiaRemision/create";
            axios
                .post(url, {
                    nIdTipoTraslado:
                        this.fillGuiaRemisionCreate.nIdTipoTraslado,
        ...
        addProduct() {
            var url = "/administracion/GuiaRemision/addProduct";
            axios
                .post(url, {
                    nIdprod: this.fillGuiaRemisionCreate.nIdprod,
                ...
                .then((response) => {
                    if (response.data.icon == "error") {
                        ...
                        this.fillGuiaRemisionCreate.nIdUnidMed=''
        ...
        setListtempGuiaRemision() {
            var url = "/administracion/GuiaRemision/ListtempGuiaRemision";
            axios.get(url, {}).then((response) => {
                this.listarGuiaRemisionPaginated = response.data.datos;
            });
        },
        ...
        eliminarTempitemPSalida() {
            var url = "/administracion/GuiaRemision/eliminarTemporder";
            axios.post(url).then((response) => {
                this.setListtempGuiaRemision();
            });
        },
