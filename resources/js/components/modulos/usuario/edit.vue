                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <el-select
                                                        v-model="
                                                            fillEditarUsuario.nIdGradoAcad
                                                        "
            ...
            axios
                ...
                .then((response) => {
                    (this.fillEditarUsuario.cFirstname =
                        ...
                        (this.fillEditarUsuario.nIdRol =
                            response.data.roles_id),
                        (this.fillEditarUsuario.nIdGradoAcad =
                            response.data.gradousers_id),
                        (this.fillEditarUsuario.nIdZonal =
                            response.data.zonal_id);
                });
        },
