              ...
              <div class="card-body">
                <form role="">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label">Apellido Materno</label>
                        <div class="col-md-9">
                          <input
                            type="text"
                            class="form-control"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <el-select
                            v-model="fillEditarUsuario.nIdGradoAcad"
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <el-select
                            v-model="fillEditarUsuario.nIdZonal"
                            placeholder="Seleccione un Rol"
                            clearable
                          >
                            <el-option
                    ...
                    <div
                      class="col-md-6"
                      v-if="
                        listRolPermisoByUsuario.includes('usuario.editarCamposClientes')
                      "
                    >
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label">Editar Cliente</label>
                        <div class="col-md-9">
                          <el-checkbox v-model="fillEditarUsuario.checkEditClient" border
                            >Editar Todos los Campos</el-checkbox
                          >
                        </div>
                      </div>
                    </div>
    ...
    getUsuarioById() {
      ...
      axios
        ...
        .then((response) => {
          ...
          if (response.data.estado_edit_cliente == 1) {
            this.fillEditarUsuario.checkEditClient = true;
          } else {
            this.fillEditarUsuario.checkEditClient = false;
          }
        });
    },
    ...
    setEditarUsuarios() {
      ...
      axios
        .post(url, {
          ...
          checkEditClient: this.fillEditarUsuario.checkEditClient,
        })
        .then((response) => {
          Swal.fire({
            icon: "success",
