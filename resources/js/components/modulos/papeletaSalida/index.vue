            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-tools">
                        ...
                        <template v-if="listRolPermisoByUsuario.includes('Papeleta.Reporte.excel')">
                            <button class="btn btn-success btn-sm" @click.prevent="getExcelpapeletaSalida">
                            ...
                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <el-select
                                                                        ...
                                                                        filterable placeholder="Seleccione una Vendedor"
                                                                        :style="{
                                                                            width: '350px',
                                                                        }" clearable>
                                                                        <el-option
                                                                            v-for="item in this.listVendedorAdmin"
                                                                            :key="item.id" :label="item.firstname +
                                                                                ' ' +
                                                                                item.secondname +
                                                                                ' ' +
                                                                                item.lastname
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <el-select
                                                                        ...
                                                                        <el-option v-for="item in listVendedorUser"
                                                                            :key="item.id" :label="item.firstname +
                                                                                ' ' +
                                                                                item.secondname +
                                                                                ' ' +
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <el-select v-model="fillBsqPapeletaSalida.nIdMotivo"
                                                                    filterable placeholder="Seleccione un cliente"
                                                                    :style="{
                                                                        width: '700px',
                                                                    }" clearable>
                                                                    <el-option v-for="item in listMotivo" :key="item.id"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <el-date-picker v-model="fillBsqPapeletaSalida.dFecha"
                                ...
                                <button class="btn btn-primary "   @click.prevent="
                                    ...
                                    " type="button">+</button>
                                                                    ...
                                                                    <td @click.prevent="getlistClientxIndex(item.id, index)"
                                                                    ...
                                                                    <td v-text="item.estado_papeleta_salida.nombre">
                                                                    </td>
                                    ...
                                    >
                                      ...
                                      Detalle2
                                                                        ...
                                                                        ">
                                                                            ...
                                                                            <template v-if="listRolPermisoByUsuario.includes('papeleta.anularAdmin')
                                                                            ">
...
<el-tab-pane label="Por Cliente" name="second">
    <div class="col-md-12">
        <template v-if="listRolPermisoByUsuario.includes('admin.listado_coti')">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">Cliente</label>
                        <div class="col-md-6">
                            <el-select v-model="fillBsqPapeletaSalida.nIdClient" filterable
                                placeholder="Seleccione una Cliente" :style="{
                                    width: '350px',
                                }" clearable>
                                <el-option v-for="item in this.listClientAdmin" :key="item.id" :label="item.razonsocial"
                                    :value="item.id">
                                </el-option>
                            </el-select>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <el-select v-model="fillBsqPapeletaSalida.nIdClient" filterable
                            ...
                            <el-option v-for="item in this.listClient" :key="item.id" :label="item.razonsocial"
                                :value="item.id">
                            </el-option>
                        </el-select>
                    </div>
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col-md-4 offset-4">
                <button class="btn btn-flat btn-info btnWidth" @click.prevent="getlistPapeleByCliente">
                    Buscar
                </button>
    ...
    <div class="card card-info">
        ...
        <div class="card-body table-responsive">
            <table class="table table-hover table-head-fixed text-nowrap projects" id="tablaprueba">
                <thead>
                    <tr>
                        <th>Fecha</th>
                        <th>Vendedor</th>
                ...
                <tbody>
                    <tr v-for="(item, index) in listPapeleByClient" :key="index">
                        <td>
                            {{ item.papeletasalida.fecha | moment("DD - MM - Y") }}
                        </td>
                        ...
                        <button @click.prevent="
                            getPdfPSalidabyVendedor(item.papeletasalida.id)
                            " class="btn btn-danger btn-sm">
                            <span><i class="far fa-file-pdf"></i></span>
                            PDF
                        </button>
...
<!-- Listado de Detalle de Cotizaciones -->
<div class="modal fade" :class="{ show: modalObservacion }" :style="modalObservacion ? mostrarModal : ocultarModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Observacion</h5>

                <button class="close" @click="abrirModalObservacion(item.id)"></button>
            </div>
            <div class="modal-body">
                <div class="card-body table-responsive">
                    <table class="table table-hover table-head-fixed text-nowrap projects">
                        <thead>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <label class="col-md-1 col-form-label">Observación</label>
                                        ...
                                        <div class="col-md-2">
                                            <button class="btn btn-success" @click="setGrabarObservacion()">
                                                Guardar
                                            </button>
                                        </div>
                                    </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" @click="abrirModalObservacion">
                    Cerrar
                </button>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        setGrabarObservacion() {
            var url = "/administracion/papeletasalida/setGrabarObservacion";
            axios
                .post(url, {
                    itemid: this.fillBsqPapeletaSalida.itemid,
                    observacion: this.fillBsqPapeletaSalida.nIdObservacion,
                })
                .then(() => {
                    this.setListObservaciones(this.fillBsqPapeletaSalida.itemid);
                    this.fillBsqPapeletaSalida.nIdObservacion = "";
                });
        },

        setListObservaciones(itemId) {
            var url = "/administracion/papeletaSalida/getListObservacionById";
            axios
                .get(url, {
                    params: {
                        id: itemId,
        ...
        abrirAnularVendedor(item) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire("Anulado!", "Tu Papeleta de Salida fue dado de Baja.", "success");
                }
            });
        },
