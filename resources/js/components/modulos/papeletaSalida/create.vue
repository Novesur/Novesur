                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <el-time-picker
                                                            v-model="
                                                                fillPapeletasalida.tHoraSalida
                                                            "
                                                            :picker-options="
                                                                rangoFechaPapeleta
                                                            "
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <el-time-picker
                                                            v-model="
                                                                fillPapeletasalida.tHoraRetorno
                                                            "
                                                            :picker-options="{
                                                                selectableRange:
                                                                    '08:00:00 - 18:00:00',
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <el-input
                                                            ...
                                                            v-model="
                                                                fillPapeletasalida.cReferencia
                                                            "
                                                        />
                                                    </div>
                                                </div>
...
export default {
    ...
    watch: {
        rpapeleta(value) {
            if (value === "3" || value === "729") {
                this.fillPapeletasalida.estadoContacto = false;
                this.fillPapeletasalida.estadoDireccion = false;
            }

            if (value === "680") {
                this.fillPapeletasalida.estadoContacto = true;
                this.fillPapeletasalida.estadoDireccion = false;
            }
        },
    },
    ...
    methods: {
        ...
        cargaRangoHorasPapeleta() {
            ...
            let horaSalida = this.fillPapeletasalida.tHoraSalida
                .toString()
                .substring(16, 25);
            ...
            var minutosHoraSalida =
                Number(vHoraSalida) * 60 + Number(vMinSalida);
        ...
        setGrabarPapeletaSalida() {
            ...
            axios
                ...
                .then((response) => {
                    if (
                        response.data.icon == "warning" ||
                        response.data.icon == "info"
                    ) {
                        Swal.fire({
                            position: "center",
