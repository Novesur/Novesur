<template>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Consulta Requerimiento Materiales - Proyecto</h1>
          </div>
        </div>
      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <el-date-picker
                                v-model="fillBPReqMateriales.cFecha"
                                type="date"
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-7">
                            <input
                              type="text"
                              class="form-control"
                              v-model="fillBPReqMateriales.cServicio"
                              :maxlength="11"
                      ...
                      >
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <el-select
                                v-model="fillBPReqMateriales.nIdProyecto"
                                style="width: 100%"
                                filterable
                                placeholder="Select"
                                clearable
      ...
      getExcelPReqMat() {
        ...
        axios
          .post(
            url,
            {
              params: { listPReqMateriales: JSON.stringify(this.listPReqMateriales) },
            },
            { responseType: "blob" }
          )
          .then((response) => {
