                                        ...
                                        <div class="row">
                                            ...
                                            ">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <el-select v-model="fillBsqCotizacion.nIdVendedor"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <el-select v-model="fillBsqCotizacion.nIdCliente" filterable
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <el-date-picker v-model="fillBsqCotizacion.dFecha"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <el-select v-model="fillBsqCotizacion.nIdtEstadoCoti2"
                                                                filterable placeholder="Seleccione un estado"
                                                                :style="{ width: '700px' }" clearable>
                                                                <el-option v-for="item in listEstadoCoti2"
                        ...
                        {{ item.fecha | moment("YYYY") }} -->
                                            ...
                                            <td v-if="item.estadopedido != 'ANULADO'">
                                                <button v-if="listRolPermisoByUsuario.includes(
                                                    'cotizacion.estado'
                                                )" class="btn btn-info btn-sm" @click="abrirEstado(item.codigo)">
        ...
        " role="document" style="top: 50% !important">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Listado de Detalle de Cotizaciones -->
                        <div class="col">
                            <el-select v-model="fillBsqCotizacion.nIdtEstadoCoti" filterable
                        ...
                        <template v-if="fillBsqCotizacion.nIdtEstadoCoti == 1">
...
export default {
    ...
    methods: {
        ...
        onChange() {
            if (this.fillBsqCotizacion.nIdtEstadoCoti == 2) {
