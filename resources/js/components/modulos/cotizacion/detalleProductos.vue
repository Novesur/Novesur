  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Listado detallado de Productos</h1>
          </div>
        </div>
      </div>
    </div>
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col">
                            <template
                              v-if="
                                listRolPermisoByUsuario.includes('detalleproductos.Excel')
                              "
                            >
                              <button
    ...
    getExcelCotizacionFecha() {
      ...
      axios
        .post(
          ...
          {
            params: {
              listDetProductByDate: JSON.stringify(this.listDetProductByDate),
            },
          },
          { responseType: "blob" }
        )
