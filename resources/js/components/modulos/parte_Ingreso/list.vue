  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Lista de Pedidos de Ingreso</h1>
          </div>
        </div>
      </div>
    </div>
                ...
                <form role="form">
                  <div class="col-md-12">
                    <div class="form-group row">
                      ...
                      <div class="col-md-5">
                        <el-select
                          v-model="fillBsqListPedido.nIdProveedor"
                          filterable
                          placeholder="Select"
                          style="width: 100%"
                          clearable
                      ...
                      <div class="col-md-4">
                        ...
                        <el-date-picker
                          v-model="fillBsqListPedido.dFecha"
                          type="daterange"
                          range-separator="To"
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-3">
                            <input
                              type="text"
                              class="form-control"
                              v-model="fillBsqListPedido.cRuc"
...
export default {
  ...
  methods: {
    limpiarMarcaBsq() {
      this.fillBsqListPedido.cNombre = "";
    },
    limpiarBandejaMarca() {
      this.listMarca = [];
    },
    getListarMarca() {
      ...
      axios
        .get(url, {
          params: {
            cNombre: this.fillBsqListPedido.cNombre,
          },
        })
        .then((response) => {
