        ...
        <div class="card-body">
          <div class="container-fluid">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Formulario Guia de Remisión</h3>
              </div>
              <div class="card-body">
                <form role="form">
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-8">
                            <el-select
                              v-model="fillGuiaRemisionCreate.nIdTipoTraslado"
                              placeholder="Select"
                              style="width: 20vw"
                            >
                              <el-option
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-md-2 col-form-label">Comprobante</label>
                          <div class="col-md-8">
                            <input
                              type="text"
                              class="form-control"
                              v-model="fillGuiaRemisionCreate.cComprobante"
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-md-2 col-form-label">Punto de Partida</label>
                          <div class="col-md-8">
                            <el-select
                              v-model="fillGuiaRemisionCreate.nIdPartida"
                              placeholder="Select"
                              style="width: 20vw"
                            >
                              <el-option
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-md-2 col-form-label">Punto de LLegada</label>
                          <div class="col-md-9">
                            <el-select
                              v-model="fillGuiaRemisionCreate.nIdLlegada"
                              placeholder="Select"
                              style="width: 20vw"
                            >
                              <el-option
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input
                              type="text"
                              class="form-control"
                              v-model="fillGuiaRemisionCreate.nidCliente"
                              :disabled="true"
                            />
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-4">
                            <input
                              ...
                              class="form-control"
                              :disabled="isDisabled"
                              v-model="fillGuiaRemisionCreate.nIdRuc"
                              v-int
                            />
                          </div>
                          <span
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-4">
                            <el-select
                              v-model="fillGuiaRemisionCreate.nIdMotivo"
                              placeholder="Select"
                              style="width: 20vw"
                            >
                              <el-option
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-md-3 col-form-label"
                            >Fecha de Inicio de Traslado</label
                          >
                          <div class="col-md-4">
                            <el-date-picker
                              v-model="fillGuiaRemisionCreate.cFechaTraslado"
                              type="date"
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="card card-primary">
                        <div class="card-header">
                          <h3 class="card-title">UNIDAD DE TRANSPORTE Y CONDUCTOR</h3>
                        </div>
                        <div class="card-body">
                          <div class="col-md-12">
                            <div class="form-group row">
                              ...
                              <div class="col-md-4">
                                <input
                                  type="text"
                                  class="form-control"
                                  v-model="fillGuiaRemisionCreate.cPlacaVehiculo"
                                />
                              </div>

                              <label class="col-md-2 col-form-label"
                                >MODALIDAD DE TRANSPORTE</label
                              >

                              <div class="col-md-4">
                                <el-select
                                  v-model="fillGuiaRemisionCreate.nIdModTransporte"
                                  placeholder="Select"
                                  style="width: 20vw"
                                >
                                  <el-option
                          ...
                          <form role="form">
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group row">
                                  <label class="col-md-2 col-form-label"
                                    >DNI DEL CONDUCTOR</label
                                  >
                                  <div class="col-md-3">
                                    <input
                                      type="text"
                                      class="form-control"
                                      v-model="fillGuiaRemisionCreate.cDniConductor"
                                      v-int
                                      :maxlength="12"
                                    />
                                  </div>
                                  ...
                                  <label class="col-md-1 col-form-label"
                                    >PESO TOTAL APROX.(KGM)
                                  </label>
                                  <div class="col-md-3">
                                    <input
                                      type="text"
                                      class="form-control"
                                      v-model="fillGuiaRemisionCreate.cPesoTotal"
                                    />
                                  </div>
                                </div>
                              </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-10">
                                        <input
                                          type="text"
                                          class="form-control"
                                          v-model="fillGuiaRemisionCreate.cObservacion"
                                          @keypress.prevent.enter="setRegistrarGRemision"
                                        />
                                      </div>
                                    </div>
                                  </div>
              ...
              <div class="content container-fluid">
                <form role="form">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group row">
                        ...
                        <div class="col-md-10">
                          <el-select
                            v-model="fillGuiaRemisionCreate.nIdprod"
                            style="width: 90%"
                            filterable
                            placeholder="Select"
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-md-4">
                          <el-select
                            v-model="fillGuiaRemisionCreate.nIdUnidMed"
                            placeholder="Select"
                            style="width: 70%"
                          >
                            <el-option
                  ...
                  <div class="row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-4">
                          <input
                            ...
                            class="form-control"
                            v-int
                            v-model="fillGuiaRemisionCreate.cCantidad"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label class="col-md-4 col-form-label">KG</label>
                        <div class="col-md-4">
                          <input
                            type="text"
                            class="form-control"
                            v-model="fillGuiaRemisionCreate.cPeso"
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-4">
                          <input
                            ...
                            class="form-control"
                            v-int
                            v-model="fillGuiaRemisionCreate.cStock"
                            readonly
                          />
                        </div>
                      </div>
                  ...
                  <div class="card card-info">
                    ...
                    <div class="card-body table-responsive">
                      ...
                      >
                        ...
                        <tbody>
                          <tr
                            v-for="(item, index) in listarGuiaRemisionPaginated"
                            :key="index"
                          >
                    ...
                    <div class="card-footer">
                      <div class="row">
                        <div class="col-md-4 offset-4">
                          <button
                            class="btn btn-flat btn-info btnWidth"
                            @click.prevent="setRegistrarGRemision"
                          >
                            Procesar
                          </button>
                          <button
  ...
  methods: {
    ...
    getListTipoTraslado() {
      ...
      axios.get(url, {}).then((response) => {
        ...
        this.fillGuiaRemisionCreate.nIdTipoTraslado = this.listTipoTraslado[0].id;
      });
    },
    ...
    getListModTransporte() {
      ...
      axios.get(url, {}).then((response) => {
        ...
        this.fillGuiaRemisionCreate.nIdModTransporte = this.listModTransporte[0].id;
      });
    },
    ...
    cargaListAlmacenEntrada() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.fillGuiaRemisionCreate.nIdPartida = this.listAlmacenPPartida[0].id;
        });
    },
    ...
    setProcesar() {
      ...
      axios
        .post(url, {
          nIdTipoTraslado: this.fillGuiaRemisionCreate.nIdTipoTraslado,
