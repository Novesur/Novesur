                            ...
                            <div class="card-body">
                                <form role="form">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <el-select v-model="fillEditarProveedor.nIdtipoCompra
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" v-if="fillEditarProveedor.nIdtipoCompra == 1">
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Ruc</label>
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"
                                                        v-model="fillEditarProveedor.cRuc" v-int :maxlength="11" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6" v-else>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control"
                                                        v-model="fillEditarProveedor.cCodigo" v-int :maxlength="13" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Swift</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control"
                                                        v-model="fillEditarProveedor.swift"
                                                       :maxlength="15" />
                                                </div>
                                            </div>
                                        </div>
        ...
        getProveedorById() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.fillEditarProveedor.nIdtipoCompra= response.data.tipo_ordencompra_id;
                    this.fillEditarProveedor.swift = response.data.swift;
                    this.fillEditarProveedor.cCodigo = response.data.ruc;
        ...
        setEditarProveedor() {
            ...
            axios
                .post(url, {
                    ...
                    'nIdtipoCompra' : this.fillEditarProveedor.nIdtipoCompra,
                    'swift': this.fillEditarProveedor.swift,
                    'cCodigo' : this.fillEditarProveedor.cCodigo
