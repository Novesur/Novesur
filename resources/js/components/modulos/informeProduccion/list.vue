                  ...
                  <tbody>
                    <tr v-for="(item, index) in listarClientesPaginated" :key="index">
                      ...
                      <td>
                        ...
                        <template v-if="listRolPermisoByUsuario.includes('infoProduccion_precio')">
                          <button class="btn btn-secondary btn-sm" @click.prevent="abrirModalInfoProd(item.id)">
                            <i class="fas fa-wrench"></i> Material
                          </button>

                          <button class="btn btn-primary btn-sm" @click.prevent="abrirModalManoObra(item.id)">
                            <i class="fas fa-user-cog"></i> Mano de Obra
                          </button>

                          <button class="btn btn-info btn-sm" @click.prevent="abrirModalOtrosReque(item.id)">
                            <i class="fas fa-list-alt"></i> Otros Reque..
                          </button>

                          <button class="btn btn-success btn-sm" @click.prevent="getExcelReporte(item.id)">
                        ...
                        <table class="table table-hover table-head-fixed text-nowrap projects">
                          ...
                          <tbody>
                            <tr v-for="(item, index) in listManObra" :key="index">
                              ...
                              <td>
                                {{
                                  item.dias * item.costdias + item.horas * item.costhoras
                                }}
                              </td>
...
export default {
  ...
  methods: {
    ...
    MandarDatosPrecio(item, costunit, cantidad, informeproduccion_id) {
      this.fillReporteInfoProduccion.precio = prompt(
        "Ingrese el precio a editar",
        costunit
      );
      this.fillReporteInfoProduccion.total =
        cantidad * this.fillReporteInfoProduccion.precio;
