                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <el-select
                                v-model="fillBsqReportePersonal.cPersonal"
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <el-date-picker
                                v-model="fillBsqReportePersonal.dFecha"
                                type="daterange"
                                range-separator="To"
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <el-date-picker
                                v-model="fillBsqReportePersonal.dFecha2"
                                type="daterange"
                                range-separator="To"
                                start-placeholder="Start date"
                                end-placeholder="End date"
                    ...
                    <div class="card-footer">
                      <div class="row">
                        <div class="col-md-9 offset-3">
                          ...
                          >
                            <span
                              ><i class="fas fa-file-excel"></i> Control por
                              tardanzas</span
                            >
                          </button>
                        </div>
