                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <el-tabs v-model="activeName">
                                    <!-- Buscar por Personal -->
                                    <el-tab-pane label="Por Personal" name="first">
                                        <form role="">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Seleccione la
                                                            Sede</label>
                                                        <div class="col-md-6">
                                                              <el-select v-model="fillBsqReportePersonal.nIdSedePersonal" @change="getListarPersonal(fillBsqReportePersonal.nIdSedePersonal)"
                                                                filterable placeholder="Seleccione una Sede"
                                                                :style="{ width: '350px' }">
                                                                <el-option v-for="item in listSede"
                                                                      :key="item.id"
                                                            :label="item.nombre"
                                                            :value="item.id">
                                                                </el-option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Personal</label>
                                                        <div class="col-md-9">
                                                            <el-select v-model="fillBsqReportePersonal.cPersonal"
                                                                placeholder="Seleccione un Personal" clearable :style="{
                                                                    width: '70%',
                                                                }">
                                                                <el-option v-for="item in listPersonal" :key="item.id"
                                                                    :label="item.ApPaterno +
                                                                        ' ' +
                                                                        item.ApMaterno +
                                                                        ' ' +
                                                                        item.nombres
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Seleccione el
                                                            Rango</label>
                                                        <div class="col-md-6">
                                                            <el-date-picker v-model="fillBsqReportePersonal.dFecha"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 offset-4">
                                                    <button class="btn btn-flat btn-info btnWidth"
                                                        @click.prevent="getListReporteAsistencia">
                                                        Buscar
                                                    </button>
                                        ...
                                        <div class="card card-info">
                                            ...
                                            <div class="card-body table-responsive">
                                                <table class="table table-hover table-head-fixed text-nowrap projects">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(item, index) in listAsistencia" :key="index">
                                                    ...
                                                    <ul class="pagination pagination-sm m-0 float-right">
                                                        <li class="page-item" v-if="pageNumber > 0">
                                                            <a href="" class="page-link"
                                                                @click.prevent="prevPage">Ant</a>
                                                        </li>
                                                        <li class="page-item" v-for="(page, index) in pagesList"
                                                            :key="index" :class="page == pageNumber ? 'active' : ''">
                                                            <a href="#" class="page-link"
                                                                @click.prevent="SelectPage(page)">{{ page + 1
                                                                }}</a>
                                                        </li>
                                                        <li class="page-item" v-if="pageNumber < pageCount - 1">
                                                            <a href="" class="page-link"
                                                                @click.prevent="nextPage">Post</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Seleccione la
                                                            Fecha</label>
                                                        <div class="col-md-6">
                                                            <el-date-picker v-model="fillBsqReportePersonal.dFecha2"
                                                                type="daterange" range-separator="To"
                                                                start-placeholder="Start date"
                                                                end-placeholder="End date" value-format="yyyy-MM-dd"
                                                                clearable :style="{
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Seleccione la
                                                            Sede</label>
                                                        <div class="col-md-6">
                                                           <el-select v-model="fillBsqReportePersonal.nIdSede"
                                                                filterable placeholder="Seleccione una Sede"
                                                                :style="{ width: '350px' }">
                                                                <el-option v-for="item in listSede"
                                                                      :key="item.id"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 offset-4">
                                                    <button class="btn btn-flat btn-info btnWidth3buttons"
                                                        @click.prevent="getListReporteAsistenciaByDate">
                                                        Buscar
                                                    </button>
                                        ...
                                        <div class="card card-info">
                                            ...
                                            <div class="card-body table-responsive">
                                                <table class="table table-hover table-head-fixed text-nowrap projects">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(item, index) in listAsistenciaByDay" :key="index">
                                                            <td v-text="item.fecha"></td>
                                                            <td v-text="item.tiempo"></td>
                                                            <td v-text="item.personal"></td>
                                                            <td v-text="item.DNI"></td>
                                                            <td v-text="item.zonal"></td>
                                                             <td v-text="item.sede"></td>
                                                            <td v-text="item.cargo"></td>
                                                            <td v-text="item.estado"></td>
                                                            <!--     <td v-if="item.estado === 'A'">
                                                Activo
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 col-form-label">Seleccione la
                                                            Sede</label>
                                                        <div class="col-md-6">
                                                           <el-select v-model="fillBsqReportePersonal.nIdSedeDetallado"
                                                                filterable placeholder="Seleccione una Sede"
                                                                :style="{ width: '350px' }">
                                                                <el-option v-for="item in listSede"
                                                                      :key="item.id"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <el-date-picker
                                                                v-model="fillBsqReportePersonal.dFechaDetalle"
                                                                type="daterange" range-separator="To"
                                                                start-placeholder="Start date"
                                                                end-placeholder="End date" value-format="yyyy-MM-dd"
                                                                clearable :style="{
                                        ...
                                        >
                                            Limpiar
                                                    ...
                                                    <button class="btn btn-flat btn-success btnWidth3buttons"
                                                        ...
                                                        <span><i class="fas fa-file-excel"></i> Control por
                                                            tardanzas</span>
                                                    </button>
                                                </div>
                                            </div>
        ...
        reporteByDateAsistExcel0113() {
            ...
            axios
                .post(
                    ...
                    {
                        params: {
                            listAsistenciaByDay0113: JSON.stringify(this.listAsistenciaByDay0113),
                        },
                    },
                    { responseType: "blob" }
                )
        ...
        reporteTardanzaExcel0113() {
            ...
            axios
                .post(
                    ...
                    {
                        params: {
                            listAsistenciaTardanza: JSON.stringify(this.listAsistenciaTardanza),
                        },
                    },
                    { responseType: "blob" }
                )
        ...
        reporteByDateAsistExcel1431() {
            ...
            axios
                .post(
                    ...
                    {
                        params: {
                            listAsistenciaByDay1431: JSON.stringify(this.listAsistenciaByDay1431),
                        },
                    },
                    { responseType: "blob" }
                )
            ...
            swalWithBootstrapButtons
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        swalWithBootstrapButtons.fire("Cancelado", "Se cancelo el proceso", "error");
                    }
                });
        },
    },
