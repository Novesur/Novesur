                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input
                        type="text"
                        class="form-control"
                        v-model="fillregistrarCotizacionLibre.cNomClient"
                        :readonly="true"
                      />
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input
                        type="text"
                        class="form-control"
                        v-model="fillregistrarCotizacionLibre.cRucClient"
                        :readonly="true"
                      />
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input
                        type="text"
                        class="form-control"
                        v-model="fillregistrarCotizacionLibre.cAtencion"
                        :readonly="true"
                      />
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input
                        type="text"
                        class="form-control"
                        v-model="fillregistrarCotizacionLibre.cFonoClient"
                        :readonly="true"
                      />
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input
                        type="text"
                        class="form-control"
                        v-model="fillregistrarCotizacionLibre.cEmail"
                        :readonly="true"
                      />
                    </div>
                  </div>
                    ...
                    <div class="card card-primary">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-4">
                            <el-select
                              v-model="fillregistrarCotizacionLibre.nIdTipoPago"
                              placeholder="Select"
                              style="width: 70%"
                            >
                              <el-option
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-4">
                            <el-select
                              v-model="fillregistrarCotizacionLibre.cFPago"
                              placeholder="Select"
                              style="width: 70%"
                            >
                              <el-option
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-4">
                            <el-select
                              v-model="fillregistrarCotizacionLibre.nIdGarantia"
                              placeholder="Select"
                              style="width: 70%"
                            >
                              <el-option
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <el-select
                          v-model="fillregistrarCotizacionLibre.nIdUnidMed"
                          placeholder="Select"
                          style="width: 70%"
                        >
                          <el-option
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-10">
                        <input
                          type="text"
                          class="form-control"
                          v-model="fillregistrarCotizacionLibre.nIdprod"
                          maxlength="250"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-4">
                        <input
                          type="text"
                          class="form-control"
                          v-model="fillregistrarCotizacionLibre.cTotal"
                          :readonly="true"
                          :onchange="this.setCalculaTotal()"
                        />
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-2">
                        <input
                          type="text"
                          class="form-control"
                          v-model="fillregistrarCotizacionLibre.cStock"
                          :readonly="true"
                        />
                      </div>
                    </div>
  ...
  methods: {
    ...
    getListarUnidadMedida() {
      ...
      axios.get(url).then((response) => {
        ...
        this.fillregistrarCotizacionLibre.nIdUnidMed = this.listUnidMed[10].id;
      });
    },
